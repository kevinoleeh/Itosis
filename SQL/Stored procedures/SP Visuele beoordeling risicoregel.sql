GO
CREATE PROCEDURE InsertVisueleBeoordelingRisicoregel
	@Projectnummer INT,
	@Rapportnummer INT,
    @Regelnummer INT,
...
AS BEGIN
	...
	BEGIN TRY
		...
		VALUES (@Projectnummer, @Rapportnummer, @Regelnummer, @Proces, @Machineonderdeel, @Afdeling)
