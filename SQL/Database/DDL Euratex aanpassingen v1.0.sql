...
GO
CREATE FUNCTION dbo.FN_GET_RISICO(@ERNST_VAN_HET_ONGEVAL NUMERIC(9, 2), @KANS_OP_BLOOTSTELLING NUMERIC(9, 2), @KANS_OP_WAARSCHIJNLIJKHEID NUMERIC(9, 2))
RETURNS NUMERIC(9, 2)
AS
BEGIN
...
GO
CREATE FUNCTION dbo.FN_GET_PRIORITEIT(@RISICO NUMERIC(9, 2))
RETURNS VARCHAR(255)
AS
BEGIN
