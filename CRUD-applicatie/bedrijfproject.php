        ...
        <div class="row table-responsive">
            <table id="table" class="table table-striped table-bordered marginTop">
                ...
                if (isset($_GET["editbedrijf"])) {
                    echo '<form action="bedrijfproject.php?edit=1" method="post">';
                    ...
                    echo '<tr>';
                    echo '<td><input type="text" value="' . $_GET["editbedrijf"] . '" name="editBEDRIJFSNAAM"></td>';
                    echo '<td><input type="text" value="' . $_GET["LOCATIE"] . '" name="editLOCATIE"><button class="buttonlink widintable" type="submit"><span class="glyphicon glyphicon-ok green"></button></td>';
                    echo '</tr>';
                    echo '</form>';
                }
