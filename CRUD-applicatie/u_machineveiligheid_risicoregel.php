...
<div class="container">
    ...
    <form action="c_machineveiligheid_risicoregel.php?projectnummer=<?= $_GET['projectnummer'] ?>&rapportnummer=<?= $_GET['rapportnummer'] ?>" method="post" id="crisicoregel">
        ...
        <div class="form-group">
          "<?php echo var_dump($result['TRANSPORT']); ?>"
            <label for="TRANSPORT">Transport</label>
            <input type="checkbox" class="form-control" name="TRANSPORT" "<?php if($result['TRANSPORT'] === "1") { echo 'checked="checked"'; } ?>">
            <label for="MONTAGE">Montage</label>
            <input type="checkbox" class="form-control" name="MONTAGE" "<?php if($result['MONTAGE'] === "1") { echo 'checked="checked"'; } ?>">
            <label for="IN_BEDRIJFSNAME">In bedrijfsname</label>
            <input type="checkbox" class="form-control" name="IN_BEDRIJFSNAME" "<?php if($result['IN_BEDRIJFNAME'] === "1") { echo 'checked="checked"'; } ?>">
            <label for="TIJDENS_PRODUCTIE">Tijdens productie</label>
            <input type="checkbox" class="form-control" name="TIJDENS_PRODUCTIE" "<?php if($result['TIJDENS_PRODUCTIE'] === "1") { echo 'checked="checked"'; } ?>">
            <label for="TIJDENS_ONDERHOUD">Tijdens onderhoud</label>
            <input type="checkbox" class="form-control" name="TIJDENS_ONDERHOUD" "<?php if($result['TIJDENS_ONDERHOUD'] === "1") { echo 'checked="checked"'; } ?>">
            <label for="TIJDENS_STORING">Tijdens storing</label>
            <input type="checkbox" class="form-control" name="TIJDENS_STORING" "<?php if($result['TIJDENS_STORING'] === "1") { echo 'checked="checked"'; } ?>">
            <label for="TIJDENS_REINIGEN">Tijdens reinigen</label>
            <input type="checkbox" class="form-control" name="TIJDENS_REINIGEN" "<?php if($result['TIJDENS_REININGEN'] === "1") { echo 'checked="checked"'; } ?>">
            <label for="TIJDENS_AFSTELLEN">Tijdens afstellen</label>
            <input type="checkbox" class="form-control" name="TIJDENS_AFSTELLEN" "<?php if($result['TIJDENS_AFSTELLEN'] === "1") { echo 'checked="checked"'; } ?>">
            <label for="DEMONTAGE">Demontage</label>
            <input type="checkbox" class="form-control" name="DEMONTAGE" "<?php if($result['DEMONTAGE'] === "1") { echo 'checked="checked"'; } ?>">
            <label for="FREQUENTIE">Frequentie</label>
            <input type="text" class="form-control" name="FREQUENTIE" "<?php if($result['FREQUENTIE'] === "1") { echo 'checked="checked"'; } ?>">
        </div>
        <div class="form-group">
