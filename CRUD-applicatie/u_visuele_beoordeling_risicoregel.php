...
<div class="container">
    ...
    <form action="u_visuele_beoordeling_risicoregel.php?projectnummer=<?= $_GET['projectnummer'] ?>&rapportnummer=<?= $_GET['rapportnummer'] ?>&regelnummer=<?= $_GET['regelnummer'] ?>" method="post" id="uvisuelebeoordeling">
